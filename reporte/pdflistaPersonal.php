...
<body>
	...
	<div id="container" >
        <table width="100%">
          <tbody>
            <tr> 
              <td><div class="tamano15">#</div></td>
              <td><div class="tamano15">Nombre</div></td>
			  <td><div class="tamano15">DNI</div></td>
              <td><div class="tamano15">Cargo</div></td>
			  <td><div class="tamano15">Celular</div></td>
			  <td><div class="tamano15">Ubicacion</div></td>
            </tr>
            <?php
			$numero= 1;
